...
namespace ProtoBuf.Meta
{
    ...
    public class ValueMember
    {
        ...
        internal string GetSchemaTypeName(HashSet<Type> callstack, bool applyNetObjectProxy, ProtoImports imports, out string altName)
        {
            Type effectiveType = ItemType ?? MemberType;
            return model.GetSchemaTypeName(callstack, effectiveType, DataFormat, applyNetObjectProxy && AsReference, applyNetObjectProxy && DynamicType, imports, out altName);
        }
